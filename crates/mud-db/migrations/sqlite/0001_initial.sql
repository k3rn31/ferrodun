...
CREATE TABLE puppets (
    entity_key INTEGER PRIMARY KEY REFERENCES entities (entity_key),
...
-- item lives in at most one container at a time.
CREATE TABLE inventory (
    item_key INTEGER PRIMARY KEY REFERENCES entities (entity_key),
    container_key INTEGER NOT NULL REFERENCES entities (entity_key)
);
